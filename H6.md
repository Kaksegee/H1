...
Kävin myös tutkimassa Apachen virhelokin viimeisintä viestiä kommenolla 
...
Seuraavaksi tein Apachen konfiguraatio testin komennoilla
 ...
 Kävin myös katsomassa Apachen virhelokin viimeisintä viestiä
  ...
  Oli käytetty aloittamaan säiettä. Virhe ei ollut siis toistunut käynnistäessä Apachea uudestaan.
